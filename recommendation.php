            ...
            <div class="container-Drugs">
                <div class="wrapper" >
                    <div class="select-btn">
                        <span name="drug_type" >Select Systemic Drugs </span>
                ...
                <div class="wrapper wrapperD" >
                    <div class="select-btn select-btn-D">
                        <span name="chronic_diseas" >Select Disease</span>
                        <i class="uil uil-angle-down"></i>
                    </div>
                    <div class="content">
                        <div class="search">
                ...
                <!-- <button action="" class="button-63 wrapper" role="button" >Submit</button> -->
                <!-- ... (rest of the HTML code remains the same) ... -->

<!-- Add a div to display the conflicts -->
<div id="conflicts"></div>

<!-- Update the submit button to call a JavaScript function -->
<button action="" class="button-63 wrapper" role="button" onclick="submitForm()">Submit</button>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($disease) || empty($drugType)) {
        echo "Error: Chronic disease or drug type is empty.";
        exit();
    }

    $conflicts = ""; // Initialize an empty string to store conflicts
    $suitableDrugs = ""; // Initialize an empty string to store suitable drugs
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Display suitable drugs
    if (!empty($suitableDrugs)) {
        echo "<strong>Recommendations:</strong><br>" . $suitableDrugs;
    } else {
        echo "No suitable drugs found for the chronic disease.";
    }

    // Display conflicts
    if (!empty($conflicts)) {
        echo "<br><strong>Conflicts:</strong><br>" . $conflicts;
    } else {
        echo "<br>No conflicts found between the drug type and the chronic disease.";
    }
...
if (!empty($conflicts)) {
    echo "<strong>Conflicts:</strong><br>" . $conflicts;
  } else {
